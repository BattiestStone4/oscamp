...
pub struct Heap {
    ...
    buddy_allocator: buddy_system_allocator::Heap<8192>,
}
...
impl Heap {
    ...
    pub unsafe fn new(heap_start_addr: usize, heap_size: usize) -> Heap {
        ...
        Heap {
            ...
            buddy_allocator: {
                let mut buddy = buddy_system_allocator::Heap::<8192>::new();
    ...
    pub fn allocate(&mut self, layout: Layout) -> AllocResult<NonNull<u8>> {
        match Heap::layout_to_allocator(&layout) {
            ...
            HeapAllocator::BuddyAllocator => self
                .buddy_allocator
                .alloc(layout)
                .map(|ptr| core::ptr::NonNull::new(ptr.as_ptr() as *mut u8).unwrap())
